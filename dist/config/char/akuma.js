...
var atk = [
    ...
    { name: 'jhp', frame: { start: 10472, end: 10478, frameRate: 10, repeat: 0 }, speed: 100, hitbox: { fx: { name: 'hitsparks-fireball', x: 20, y: -20 }, start: 2, active: 4, hits: [5], x: 40, y: -20, width: 80, height: 30, damage:20, stun: 20, onBlk: 1, onHit: 8, push: 10, atklvl: 'h' } },
    ...
    { name: 'jhk', frame: { start: 10498, end: 10502, frameRate: 10, repeat: 0 }, speed: 100, hitbox: { fx: { name: 'hitsparks-fireball', x: 20, y: -20 }, start: 2, active: 4, hits: [5], x: 50, y: -20, width: 80, height: 30, damage:20, stun: 20, onBlk: 1, onHit: 8, push: 10, atklvl: 'h' } },
]
var cricarts = [
