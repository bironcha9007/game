...
var atk = [
    ...
    { name: 'jlk', frame: { start: 10420, end: 10424, frameRate: 12, repeat: 0 }, speed: 100, hitbox: { fx: { name: 'hitsparks-small', x: 20, y: 0 }, start: 1, active: 2, hits: [3], x: 50, y: 25, width: 60, height: 20, damage: 25, stun: 10, onBlk: 1, onHit: 4, push: 10, atklvl: 'h' } },
