var Stage = new Phaser.Class({
    ...
    loadImages: function () {
        this.scene.load.image('akuma-1', '/dist//assets/stages/akuma/akuma-2.png')
        this.scene.load.image('akuma-2', '/src/assets/stages/akuma/akuma-2.png')
        this.scene.load.image('akuma-3', '/src/assets/stages/akuma/akuma-3.png')
    },
    start: function(){
